...
const Checkout = ({setOrder}) => {
  ...
  if (
    ...
    setError("Please enter all details before placing order.")
    return
  }
    if (!paymentMethod) {
        ...
        <div className='flex flex-col md:flex-row justify-between space-x-10 mt-8'>
            <div className='md:w-2/3'>
               ...
               <div className={`space-y-4 ${billingToggle ? "" : "hidden"}`}>
                  ...
                  <div>
                     <label className='block text-grey-700'>Phone</label>
                     <input 
                       type="text" 
                       name="phone"
              ...
              <div className='border p-2 mb-6'>
               ...
               <div className={`space-y-4 ${shippingToggle ? "" : "hidden"}`}>
                  ...
                  <div>
                     <label className='block text-grey-700'>Zip Code</label>
                     <input 
                       type="text" 
                       name="zip"
               ...
               <div className={`space-y-4 ${paymentToggle ? "" : "hidden"}`}>
                  <div className='flex items-center mb-2'>
                     <input 
                       ...
                       <label className='block text-grey-700 ml-2'>Cash on Delivery</label>
                  </div>
                  <div className='flex items-center mb-2'>
                     <input 
                       type="radio" 
                       ...
                       <label className='block text-grey-700 ml-2'>Debit Card</label>
                  </div> 
                  {paymentMethod === "dc" && (
